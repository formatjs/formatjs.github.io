...
// EXTERNAL MODULE: ../node_modules/.pnpm/@orama+orama@2.0.17/node_modules/@orama/orama/dist/utils.js
var utils = __webpack_require__(2758);
// EXTERNAL MODULE: ../node_modules/.pnpm/@orama+orama@2.0.17/node_modules/@orama/orama/dist/components/documents-store.js
var documents_store = __webpack_require__(3408);
// EXTERNAL MODULE: ../node_modules/.pnpm/@orama+orama@2.0.17/node_modules/@orama/orama/dist/errors.js
var errors = __webpack_require__(1801);
;// CONCATENATED MODULE: ../node_modules/.pnpm/@orama+orama@2.0.17/node_modules/@orama/orama/dist/components/plugins.js
...
async function getAllPluginsByHook(orama, hook) {
    ...
    for(let i = 0; i < pluginsLength; i++){
        try {
            ...
            throw (0,errors/* createError */.T)('PLUGIN_CRASHED');
        }
    }
    return pluginsToRun;
}
...
// EXTERNAL MODULE: ../node_modules/.pnpm/@orama+orama@2.0.17/node_modules/@orama/orama/dist/components/hooks.js
var hooks = __webpack_require__(6456);
// EXTERNAL MODULE: ../node_modules/.pnpm/@orama+orama@2.0.17/node_modules/@orama/orama/dist/components/index.js + 4 modules
var dist_components = __webpack_require__(5514);
// EXTERNAL MODULE: ../node_modules/.pnpm/@orama+orama@2.0.17/node_modules/@orama/orama/dist/components/internal-document-id-store.js
var internal_document_id_store = __webpack_require__(4033);
// EXTERNAL MODULE: ../node_modules/.pnpm/@orama+orama@2.0.17/node_modules/@orama/orama/dist/components/tokenizer/languages.js
var languages = __webpack_require__(3883);
;// CONCATENATED MODULE: ../node_modules/.pnpm/@orama+orama@2.0.17/node_modules/@orama/orama/dist/components/sorter.js
...
function innerCreate(orama, sharedInternalDocumentStore, schema, sortableDeniedProperties, prefix) {
    ...
    for (const [prop, type] of Object.entries(schema)){
        ...
        if (typeof type === 'object' && !Array.isArray(type)) {
            ...
            (0,utils/* safeArrayPush */.hT)(sorter.sortableProperties, ret.sortableProperties);
            sorter.sorts = {
                ...sorter.sorts,
                ...ret.sorts
            };
        ...
        if (!(0,defaults.isVectorType)(type)) {
            switch(type){
                ...
                case 'string[]':
                    continue;
                default:
                    throw (0,errors/* createError */.T)('INVALID_SORT_SCHEMA_TYPE', Array.isArray(type) ? 'array' : type, path);
            }
        }
    }
    return sorter;
...
async function insert(sorter, prop, id, value) {
    ...
    const internalId = (0,internal_document_id_store/* getInternalDocumentId */.HM)(sorter.sharedInternalDocumentStore, id);
...
function stringSort(language, value, d) {
    return value[1].localeCompare(d[1], (0,languages/* getLocale */.Kd)(language));
}
...
async function sortBy(sorter, docIds, by) {
    if (!sorter.enabled) {
        throw (0,errors/* createError */.T)('SORT_DISABLED');
    }
    const property = by.property;
    const isDesc = by.order === 'DESC';
    const s = sorter.sorts[property];
    if (!s) {
        throw (0,errors/* createError */.T)('UNABLE_TO_SORT_ON_UNKNOWN_FIELD', property, sorter.sortableProperties.join(', '));
    }
    ...
    docIds.sort((a, b)=>{
        ...
        const indexOfA = s.docs.get((0,internal_document_id_store/* getInternalDocumentId */.HM)(sorter.sharedInternalDocumentStore, a[0]));
        const indexOfB = s.docs.get((0,internal_document_id_store/* getInternalDocumentId */.HM)(sorter.sharedInternalDocumentStore, b[0]));
...
// EXTERNAL MODULE: ../node_modules/.pnpm/@orama+orama@2.0.17/node_modules/@orama/orama/dist/components/tokenizer/index.js + 2 modules
var components_tokenizer = __webpack_require__(2853);
;// CONCATENATED MODULE: ../node_modules/.pnpm/@orama+orama@2.0.17/node_modules/@orama/orama/dist/methods/create.js
...
function validateComponents(components) {
    const defaultComponents = {
        ...
        getDocumentProperties: utils/* getDocumentProperties */.OX,
        validateSchema: defaults.validateSchema
    };
    for (const rawKey of hooks/* FUNCTION_COMPONENTS */.RI){
        const key = rawKey;
        if (components[key]) {
            if (typeof components[key] !== 'function') {
                throw (0,errors/* createError */.T)('COMPONENT_MUST_BE_FUNCTION', key);
            }
        } else {
    ...
    for (const rawKey of Object.keys(components)){
        if (!hooks/* OBJECT_COMPONENTS */.me.includes(rawKey) && !hooks/* FUNCTION_COMPONENTS */.RI.includes(rawKey)) {
            throw (0,errors/* createError */.T)('UNSUPPORTED_COMPONENT', rawKey);
        }
    }
}
async function create_create({ schema , sort , language , components , id , plugins  }) {
    ...
    if (components.tokenizer && language) {
        ...
        throw (0,errors/* createError */.T)('NO_LANGUAGE_WITH_CUSTOM_TOKENIZER');
    }
    const internalDocumentStore = (0,internal_document_id_store/* createInternalDocumentIDStore */.Lo)();
    ...
    if (afterCreate) {
        await (0,hooks/* runAfterCreate */.ok)(afterCreate, orama);
    }
    return orama;
}
function getVersion() {
